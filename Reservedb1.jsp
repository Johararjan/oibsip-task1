...
<%
 try {
		                	...
		                	Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/trainsystem","root","@Arjan196");
							...
							{
								%>
								<script>alert("Ticker Booked Successfully PRN="+<%=prn%>)</script>
